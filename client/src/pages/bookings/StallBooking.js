        ...
        <div className='stallcontainer'>
          ...
          <input className='seatsinput' value={numberOfSeats} onChange={(ev) => setNumberOfSeats(ev.target.value)}/>
                ...
                <p>
                  ...
                  onClick={termsConditions}>Book Stalls</button>
                </p>
                {/* <button className='confirmbtn' onClick={confirmBooking}>Book Stalls</button> */}
                {/* <Grid container>
                  <Grid item>
                    <Link to={"./terms"} >
                      <Button  > Book Stalls</Button>
                    </Link>
                  </Grid>
                </Grid> */}


                {/* <form action='/bookings/Terms' className='inline'>
                <button  className='Terms'>Book Stalls</button>
                </form> */}
